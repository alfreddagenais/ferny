...
class Tab extends EventEmitter {
  ...
  constructor (window, id, appPath, group, theme) {
    ...
    this.view.webContents.on('did-navigate', (event, url, httpResponseCode, httpStatusText) => {
      this.window.webContents.send('tabRenderer-setTabIcon', {
        id: this.id,
        icon: join(__dirname, '/../../imgs/gifs/page-loading.gif')
      })
    ...
    this.view.webContents.on('context-menu', (event, params) => {
      ...
      if (params.isEditable) {
        const editableItems = [{
          label: 'Cut',
          icon: this.appPath + '/imgs/icons16/cut.png',
          ...
          label: 'Copy',
          icon: this.appPath + '/imgs/icons16/copy.png',
          ...
          label: 'Paste',
          icon: this.appPath + '/imgs/icons16/paste.png',
          ...
          icon: this.appPath + '/imgs/icons16/paste-special.png',
          ...
          label: 'Undo',
          icon: this.appPath + '/imgs/icons16/undo.png',
          ...
          label: 'Redo',
          icon: this.appPath + '/imgs/icons16/redo.png',
          ...
          label: 'Select all',
          icon: this.appPath + '/imgs/icons16/select-all.png',
          ...
          label: 'Delete',
          icon: this.appPath + '/imgs/icons16/delete.png',
        ...
        if (params.linkURL.length > 0) {
          ...
          const linkItems = [{
            ...
            icon: this.appPath + '/imgs/icons16/tab.png',
            click: () => {
              this.emit('add-tab', params.linkURL, false)
            }
          }, { type: 'separator' }, {
            label: 'Copy link text',
            icon: this.appPath + '/imgs/icons16/text.png',
            enabled: (params.linkText > 0),
            click: () => {
            ...
            label: 'Bookmark link',
            icon: this.appPath + '/imgs/icons16/add-bookmark.png',
            click: () => {
        ...
        if (params.hasImageContents) {
          ...
          const imageItems = [{
            ...
            icon: this.appPath + '/imgs/icons16/image.png',
            click: () => {
              this.emit('add-tab', params.srcURL, true)
            }
          }, { type: 'separator' }, {
            label: 'Download image',
            icon: this.appPath + '/imgs/icons16/download.png',
            click: () => {
        ...
        if (pageBool) {
          const pageItems = [{
            ...
            label: 'Forward',
            icon: this.appPath + '/imgs/icons16/forward.png',
            ...
            label: 'Reload',
            icon: this.appPath + '/imgs/icons16/reload.png',
            accelerator: 'F5',
            click: () => {
              this.reload()
            }
            ...
            icon: this.appPath + '/imgs/icons16/code.png',
            click: () => {
              this.viewPageSource()
            }
          }
      ...
      rmbMenuItems.push({
        ...
        icon: this.appPath + '/imgs/icons16/inspect.png',
        click: () => {
  ...
  showMenu () {
    const tabMenu = Menu.buildFromTemplate([{
      ...
      icon: this.appPath + '/imgs/icons16/db-reload.png',
      ...
      label: 'Go home',
      icon: this.appPath + '/imgs/icons16/home.png',
      ...
      label: 'Move tab',
      icon: this.appPath + '/imgs/icons16/move-horizontal.png',
      submenu: [{
        label: 'Move left',
        ...
        icon: this.appPath + '/imgs/icons16/to-start.png',
        click: () => {
          this.moveToStart()
        }
      }, {
        ...
        icon: this.appPath + '/imgs/icons16/to-end.png',
        click: () => {
          this.moveToEnd()
        }
      }
      ...
      icon: this.appPath + '/imgs/icons16/swipe-right.png',
      click: () => {
        this.closeToTheRight()
      }
    }, {
      label: 'Close others',
      icon: this.appPath + '/imgs/icons16/swipe-both.png',
