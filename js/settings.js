...
function requestTheme (theme, dark) { // eslint-disable-line no-unused-vars
  let cbName = theme
  if (dark) {
  ...
  saveFileToJsonFolder(null, 'theme', JSON.stringify({ name: theme, dark })).then((bool) => {
...
function chooseDownloadsFolder () { // eslint-disable-line no-unused-vars
...
function openDownloadsFolder () { // eslint-disable-line no-unused-vars
  ipcRenderer.send('main-openDownloadsFolder')
}

function requestTabClosed (tabClosed) { // eslint-disable-line no-unused-vars
...
function requestLastTab (lastTab) { // eslint-disable-line no-unused-vars
...
function requestStartup (startup) { // eslint-disable-line no-unused-vars
...
function useHomePage (url) { // eslint-disable-line no-unused-vars
  document.getElementById('home-page-input').value = url
  saveHomePage()
}

function clearBrowsingData () { // eslint-disable-line no-unused-vars
  const clearCache = document.getElementById('clear-cache-checkbox').checked
  const clearStorage = document.getElementById('clear-storage-checkbox').checked
...
function requestWinControls (bool) { // eslint-disable-line no-unused-vars
