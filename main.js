  ...
  autoUpdater.on('download-progress', (progress) => {
    if (progress != null) {
      ...
      if (perc % 25 === 0 && perc !== 100) {
        mainWindow.webContents.send('notificationManager-addQuestNotif', {
          text: `Update is being downloaded: ${perc}%`,
          ops: [{
            text: 'Cancel',
            icon: 'cancel-16',
            click: 'cancelUpdate();'
...
ipcMain.on('overlay-showMenu', (event, id) => {
  Menu.buildFromTemplate([{
    label: 'Back',
    icon: this.appPath + '/imgs/icons16/back.png',
...
function initTabManager (theme) {
  ...
  tabManager.on('add-status-notif', (text, type) => {
    mainWindow.webContents.send('notificationManager-addStatusNotif', { text, type })
  })
...
function sideMenuConstructor (hasActiveTab, hasTabs) {
  const constructor = [{
    label: 'Tab group',
    icon: app.getAppPath() + '/imgs/icons16/blocks.png',
    submenu: [{
      label: 'New tab',
      ...
      label: 'Switch tab',
      enabled: hasTabs,
      icon: app.getAppPath() + '/imgs/icons16/list.png',
      submenu: [{
        label: 'Next tab',
      ...
      submenu: [{
        label: 'Green',
        icon: app.getAppPath() + '/imgs/icons16/one.png',
        ...
        enabled: false,
        label: 'Incognito',
        icon: app.getAppPath() + '/imgs/icons16/incognito.png',
      ...
      enabled: hasTabs,
      icon: app.getAppPath() + '/imgs/icons16/close.png',
    ...
    icon: app.getAppPath() + '/imgs/icons16/tab.png',
    submenu: [{
      label: 'Back',
      accelerator: 'Alt+Left',
      icon: app.getAppPath() + '/imgs/icons16/back.png',
      click: () => {
        if (tabManager.hasActiveTab()) {
          tabManager.getActiveTab().goBack()
        }
      ...
      icon: app.getAppPath() + '/imgs/icons16/forward.png',
      click: () => {
        if (tabManager.hasActiveTab()) {
          tabManager.getActiveTab().goForward()
        }
      ...
      label: 'Reload',
      icon: app.getAppPath() + '/imgs/icons16/reload.png',
      accelerator: 'F5',
      click: () => {
        if (tabManager.hasActiveTab()) {
          tabManager.getActiveTab().reload()
      ...
      icon: app.getAppPath() + '/imgs/icons16/db-reload.png',
      ...
      label: 'Duplicate',
      icon: app.getAppPath() + '/imgs/icons16/copy.png',
      ...
      label: 'Copy URL',
      icon: app.getAppPath() + '/imgs/icons16/link.png',
      ...
      label: 'Go home',
      icon: app.getAppPath() + '/imgs/icons16/home.png',
      ...
      label: 'Move tab',
      icon: app.getAppPath() + '/imgs/icons16/move-horizontal.png',
      submenu: [{
        label: 'Move left',
        ...
        icon: app.getAppPath() + '/imgs/icons16/to-start.png',
        click: () => {
          if (tabManager.hasActiveTab()) {
        ...
        icon: app.getAppPath() + '/imgs/icons16/to-end.png',
        click: () => {
          if (tabManager.hasActiveTab()) {
      ...
      icon: app.getAppPath() + '/imgs/icons16/swipe-right.png',
      click: () => {
        if (tabManager.hasActiveTab()) {
      ...
      label: 'Close others',
      icon: app.getAppPath() + '/imgs/icons16/swipe-both.png',
    ...
    label: 'Bookmarks',
    icon: app.getAppPath() + '/imgs/icons16/bookmarks.png',
    submenu: [{
      ...
      enabled: hasActiveTab,
      icon: app.getAppPath() + '/imgs/icons16/add-bookmark.png',
    ...
    icon: app.getAppPath() + '/imgs/icons16/history.png',
    click: () => {
      overlay.scrollToId('history-title')
    }
  }, {
    label: 'Downloads',
    icon: app.getAppPath() + '/imgs/icons16/download.png',
    submenu: [{
      label: 'Downloads',
      ...
      label: 'Open folder',
      icon: app.getAppPath() + '/imgs/icons16/folder.png',
      click: () => {
        openDownloadsFolder()
      }
    }
    ...
    label: 'Zoom',
    icon: app.getAppPath() + '/imgs/icons16/zoom.png',
    submenu: [{
      label: 'Zoom in',
      enabled: hasActiveTab,
      icon: app.getAppPath() + '/imgs/icons16/zoom-in.png',
      ...
      label: 'Zoom out',
      enabled: hasActiveTab,
      icon: app.getAppPath() + '/imgs/icons16/zoom-out.png',
      accelerator: 'CmdOrCtrl+-',
      click: () => {
        if (tabManager.hasActiveTab()) {
          tabManager.getActiveTab().zoomOut()
      ...
      label: 'Fullscreen',
      icon: app.getAppPath() + '/imgs/icons16/fullscreen.png',
      accelerator: 'F11',
      click: () => {
        toggleFullscreen()
      }
    ...
    submenu: [{
      label: 'Cut',
      icon: app.getAppPath() + '/imgs/icons16/cut.png',
      ...
      label: 'Paste',
      icon: app.getAppPath() + '/imgs/icons16/paste.png',
      ...
      icon: app.getAppPath() + '/imgs/icons16/paste-special.png',
      ...
      label: 'Undo',
      icon: app.getAppPath() + '/imgs/icons16/undo.png',
      ...
      label: 'Redo',
      icon: app.getAppPath() + '/imgs/icons16/redo.png',
      ...
      label: 'Select all',
      icon: app.getAppPath() + '/imgs/icons16/select-all.png',
      ...
      label: 'Delete',
      icon: app.getAppPath() + '/imgs/icons16/delete.png',
    ...
    label: 'Page',
    enabled: hasActiveTab,
    icon: app.getAppPath() + '/imgs/icons16/file.png',
    submenu: [{
      label: 'Find in page',
      icon: app.getAppPath() + '/imgs/icons16/zoom.png',
      submenu: [{
      ...
      enabled: false,
      label: 'Certificate info',
      icon: app.getAppPath() + '/imgs/icons16/license.png',
      click: () => {
        // mainWindow.webContents.send('action-page-certificate');
      }
    }, { type: 'separator' }, {
      ...
      icon: app.getAppPath() + '/imgs/icons16/code.png',
      ...
      icon: app.getAppPath() + '/imgs/icons16/tool.png',
      accelerator: 'F12',
      click: () => {
        if (tabManager.hasActiveTab()) {
    ...
    label: 'Settings',
    icon: app.getAppPath() + '/imgs/icons16/settings.png',
    accelerator: 'CmdOrCtrl+,',
    click: () => {
      showSettingsWindow()
    }
    ...
    label: 'Help',
    icon: app.getAppPath() + '/imgs/icons16/help.png',
    submenu: [{
      ...
      label: 'About',
      icon: app.getAppPath() + '/imgs/icons16/info.png',
      ...
      icon: app.getAppPath() + '/imgs/icons16/bug-report.png',
    ...
    label: 'More',
    icon: app.getAppPath() + '/imgs/icons16/more.png',
    submenu: [{
      label: 'Clear browsing data',
      icon: app.getAppPath() + '/imgs/icons16/clean.png',
      ...
      label: 'Show overlay',
      enabled: hasActiveTab,
      icon: app.getAppPath() + '/imgs/icons16/overlay.png',
      accelerator: 'F1',
      click: () => {
        overlay.show()
      }
      ...
      icon: app.getAppPath() + '/imgs/icons16/key.png',
      submenu: [{
        label: 'New tab',
        icon: app.getAppPath() + '/imgs/icons16/create.png',
      ...
      submenu: [{
        ...
        icon: app.getAppPath() + '/imgs/icons16/window.png',
    ...
    label: 'Quit Ferny',
    icon: app.getAppPath() + '/imgs/icons16/exit.png',
